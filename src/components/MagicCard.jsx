...
const DEFAULT_GLOW_COLOR = '68, 215, 158'; // #44D79E converted to RGB
...
const MagicCard = ({
    ...
    // CSS Wrapper for styles specific to this card
    return (
        <>
            <style>
                {`
          ...
          .magic-card-glow::after {
           ...
           .magic-card-glow:hover::after {
            opacity: 1;
            animation: border-rotate 4s linear infinite; /* Slowed down to 4s */
           }
        `}
            </style>
            <div
